...
docker pull public.ecr.aws/karpenter/controller:v0.6.0
docker pull public.ecr.aws/karpenter/webhook:v0.6.0
docker tag public.ecr.aws/karpenter/webhook:v0.6.0 $ACCOUNT_ID.dkr.ecr.$AWS_REGION.amazonaws.com/karpenter/webhook:v0.6.0
docker tag public.ecr.aws/karpenter/controller:v0.6.0 $ACCOUNT_ID.dkr.ecr.$AWS_REGION.amazonaws.com/karpenter/controller:v0.6.0
docker push $ACCOUNT_ID.dkr.ecr.$AWS_REGION.amazonaws.com/karpenter/webhook:v0.6.0
docker push $ACCOUNT_ID.dkr.ecr.$AWS_REGION.amazonaws.com/karpenter/controller:v0.6.0